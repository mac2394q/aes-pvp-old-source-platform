		...
		<!-- Alternative Content Box Start -->
		 <div class="contentcontainer">
			...
			<div class="contentbox">
				<form action="<?=SITE_URL?>catalog/savesector/<?=$sector["id"]?>" method="post">
					<p>
						<label for="name"><strong>Nombre:</strong></label>
						<input type="text" id="name" name="name" class="inputbox" value="<?=$sector["name"]?>"> <br />
					</p>
					<p class="buttons">
						<input type="submit" value="<?=LBL_SAVE?>" class="btnalt">
						<input type="button" value="Regresar" class="btnalt" onclick="location.replace('<?=SITE_URL?>catalog/sectors');">
					</p>
				</form>
			</div>
