...
?>
		 <div class="contentcontainer">
			<div class="headings altheading">
				<h2>Confirmar Auditor&iacute;as</h2>
			</div>
...
?>
						<tr>
							...
							<td>
								<form action="<?=SITE_URL?>audit/accept/<?=$audit["id"]?>" method="post">
									<input type="submit" value="Confirmar" class="btnalt">
								</form>
							</td>
						</tr>
<?php 
